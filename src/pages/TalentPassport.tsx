            ...
            <div className="mx-auto max-w-[1600px] space-y-2.5 sm:space-y-3 lg:space-y-3">
                ...
                <section className="relative overflow-hidden rounded-[18px] bg-[#071A38] p-3.5 text-white shadow-sm sm:rounded-[20px] sm:p-4 lg:rounded-[22px] lg:p-5">
                    ...
                    <div className="relative">
                        ...
                        <h2 className="mt-1.5 text-lg font-black sm:text-xl">
                            Where This Plan Is Trying To Take You
                        </h2>
                ...
                <section className="rounded-[18px] border border-slate-200 bg-white p-3.5 shadow-sm sm:rounded-[20px] sm:p-4 lg:rounded-[22px] lg:p-5">
                    ...
                    <div className="grid gap-3 lg:grid-cols-[1.1fr_0.9fr]">
                        ...
                        <div className="rounded-[18px] border border-orange-200 bg-orange-500 p-3.5 text-white shadow-sm sm:rounded-[20px] sm:p-4 lg:rounded-[22px] lg:p-5">
                            ...
                            <div className="mt-1 flex items-end gap-1">
                                ...
                                <span className="pb-0.5 text-[9px] font-black text-orange-100 sm:text-[10px]">
                                    /100
                                </span>
                            </div>

                            <p className="mt-1 text-[9px] font-medium leading-3.5 text-orange-50 sm:text-[10px]">
                            ...
                            {recommendedCompetitions.length > 0 && (
                                <>
                                    <p className="mt-3 text-[9px] font-black uppercase tracking-wider text-orange-100">
                                    ...
                                    <div className="mt-1.5 space-y-1.5">
                                        {recommendedCompetitions.slice(0, 3).map(competition => (
                                            ...
                                            >
                                                <span className="text-[9px] font-black text-[#07142D] sm:text-[10px]">
                                                    {competition.name}
                                                </span>
                                                <span className="shrink-0 text-[9px] font-black text-green-700 sm:text-[10px]">
