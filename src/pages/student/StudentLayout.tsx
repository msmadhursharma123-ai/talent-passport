...
export type StudentTab="dna-radar"|"homeboard"|"timeline"|"portfolio"|"competitions"|"opportunities"|"mauke-pe-chauka"|"my-analysis"|"growth-plan";
interface Props{activeTab:StudentTab;setActiveTab:(tab:StudentTab)=>void;onLogout:()=>void;children:React.ReactNode;enabledTabs?:string[];}
const tabs=[
