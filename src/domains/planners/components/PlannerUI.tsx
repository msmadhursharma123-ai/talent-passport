...
.planner-filter-bar{display:grid;grid-template-columns:minmax(220px,2fr) minmax(130px,1fr) minmax(130px,1fr) minmax(180px,1.25fr);gap:7px;align-items:end;margin-top:12px;padding:9px;background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px}
.planner-filter-field{display:flex;flex-direction:column;gap:4px;min-width:0}.planner-filter-field label{font-size:8px;font-weight:800;color:#64748B;letter-spacing:.7px;text-transform:uppercase}.planner-filter-field input,.planner-filter-field select{width:100%;min-width:0;box-sizing:border-box;border:1px solid #CBD5E1;border-radius:8px;padding:7px 8px;background:#FFF;color:#0F172A;font:inherit;font-size:10px;outline:none;height:31px}.planner-filter-field input:focus,.planner-filter-field select:focus{border-color:#FDBA74;box-shadow:0 0 0 3px rgba(249,115,22,.08)}.planner-filter-custom{display:grid;grid-template-columns:1fr 1fr;gap:5px;min-width:0}
.planner-recommendations{margin-top:12px;padding:11px;border:1px solid #E2E8F0;border-radius:12px;background:#F8FAFC}.planner-recommendations-head{display:flex;align-items:center;justify-content:space-between;gap:8px}.planner-recommendations-title{font-size:10px;font-weight:800;color:#334155}.planner-recommendations-copy{font-size:8px;color:#94A3B8;margin-top:2px}.planner-recommendation-scroll{display:flex;gap:8px;overflow-x:auto;padding:8px 1px 3px;-webkit-overflow-scrolling:touch;scroll-snap-type:x proximity}.planner-recommendation-card{flex:0 0 245px;min-width:0;padding:10px;border:1px solid #E2E8F0;border-radius:11px;background:#FFF;scroll-snap-align:start}.planner-recommendation-title{font-size:11px;font-weight:800;color:#0F172A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.planner-recommendation-meta{margin-top:4px;color:#64748B;font-size:8px;line-height:1.45}.planner-recommendation-match{display:inline-flex;margin-top:6px;padding:3px 6px;border-radius:999px;background:#ECFDF5;color:#15803D;font-size:7px;font-weight:800}.planner-recommendation-actions{display:flex;gap:5px;margin-top:8px}.planner-recommendation-actions .planner-btn{padding:6px 8px;font-size:8px}.planner-chapter-entry{display:flex;gap:6px;align-items:end}.planner-chapter-entry .planner-field{flex:1}.planner-chapter-entry .planner-btn{white-space:nowrap}.planner-chapter-list{display:flex;flex-wrap:wrap;gap:5px;margin-top:6px}.planner-chapter-chip{display:inline-flex;align-items:center;gap:4px;padding:4px 6px;border:1px solid #FED7AA;border-radius:999px;background:#FFF7ED;color:#9A3412;font-size:8px;font-weight:800}.planner-chapter-chip button{border:0;background:transparent;color:#9A3412;cursor:pointer;padding:0;font-weight:900}.planner-recommendation-loading{font-size:8px;color:#64748B;padding:7px 1px}.planner-recommendation-empty{font-size:8px;color:#94A3B8;padding:7px 1px}.planner-recommendation-error{font-size:8px;color:#B91C1C;padding:7px 1px}
@media(max-width:1024px){.planner-page{padding:10px}.planner-hero{padding:16px 18px;margin-bottom:10px;border-radius:18px}.planner-title{font-size:25px;margin:6px 0}.planner-copy{font-size:12px;line-height:1.4}.planner-section{padding:16px;margin-bottom:10px;border-radius:17px}.planner-section-title{font-size:19px}.planner-section-copy{font-size:11px}.template-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.planner-grid{gap:7px}.block-picker{grid-template-columns:repeat(4,minmax(0,1fr))}.planner-table{font-size:9px}.planner-recommendation-card{flex-basis:195px;padding:8px}.planner-recommendation-title{font-size:9px}.planner-recommendation-meta{font-size:7px}.planner-recommendation-actions .planner-btn{padding:5px 6px;font-size:7px}.planner-chapter-entry{gap:5px}.planner-chapter-chip{font-size:7px}.planner-filter-bar{grid-template-columns:minmax(0,1.7fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1.25fr);gap:5px;padding:7px}.planner-filter-field label{font-size:7px}.planner-filter-field input,.planner-filter-field select{height:29px;padding:6px;font-size:8px}.planner-filter-custom{gap:3px}.planner-table th{font-size:8px}.planner-table td{padding:7px}.question-meta-row{grid-template-columns:minmax(135px,1fr) 82px 34px;gap:7px}.question-meta-field label,.question-prompt-field label{font-size:8px}.question-meta-field select,.question-meta-field input{height:32px;font-size:10px;padding:7px 8px}.question-prompt-field textarea{font-size:10px;min-height:58px}.question-remove{width:32px;height:32px}.paper-a4{width:720px;min-height:1018px;padding:38px}.planner-modal{padding:10px}.planner-modal-card{max-height:95vh;border-radius:14px}}
@media(max-width:600px){.planner-page{padding:7px}.planner-hero{padding:12px 13px;border-radius:14px}.planner-eyebrow{font-size:7px;letter-spacing:.95px}.planner-title{font-size:18px;line-height:1.08}.planner-copy{font-size:9px;line-height:1.32}.planner-section{padding:11px;border-radius:14px}.planner-section-title{font-size:15px}.planner-section-copy{font-size:9px}.planner-grid{grid-template-columns:1fr;gap:6px}.planner-field label{font-size:7px}.planner-field input,.planner-field select,.planner-field textarea{padding:7px 8px;border-radius:8px;font-size:9px}.planner-field textarea{min-height:58px}.template-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.template-card{min-height:105px;padding:8px;border-radius:11px}.template-preview{height:57px;padding:5px}.template-name{font-size:9px;margin-top:6px}.template-meta{font-size:7px}.block-picker{grid-template-columns:repeat(4,minmax(0,1fr));gap:5px}.block-add{padding:6px 3px;font-size:6.5px;border-radius:7px}.block-row{grid-template-columns:20px 72px minmax(0,1fr) 24px;gap:5px;padding:6px;border-radius:8px}.block-index{width:20px;height:20px;font-size:7px}.block-type{font-size:6.5px}.block-row input{padding:6px;font-size:8px}.block-remove{width:22px;height:22px}.planner-btn{padding:7px 8px;font-size:8px;border-radius:8px}.planner-table{min-width:700px;font-size:8px}.planner-filter-bar{grid-template-columns:minmax(0,1.7fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1.2fr);gap:4px;padding:6px;margin-top:8px}.planner-filter-field{gap:3px}.planner-filter-field label{font-size:6px;letter-spacing:.4px}.planner-filter-field input,.planner-filter-field select{height:26px;padding:5px;font-size:7px;border-radius:7px}.planner-filter-custom{gap:2px}.planner-filter-custom input{font-size:6.5px;padding:4px}.lesson-preview-table{min-width:820px;font-size:8px}.lesson-preview-table th{font-size:6.5px;padding:6px}.lesson-preview-table td{padding:6px}.lesson-preview-image{max-width:90px;max-height:65px}.question-meta-row{grid-template-columns:minmax(0,1fr) 78px 30px;gap:6px;align-items:end}.question-meta-row .question-type-field{grid-column:1}.question-meta-row .question-marks-field{grid-column:2}.question-meta-row .question-remove-field{grid-column:3}.question-meta-field label,.question-prompt-field label{font-size:7px}.question-meta-field select,.question-meta-field input{height:30px;font-size:9px;padding:6px 7px;border-radius:8px}.question-remove{width:30px;height:30px;border-radius:8px;font-size:10px}.question-prompt-field{margin-top:7px}.question-prompt-field textarea{min-height:54px;font-size:9px;padding:7px 8px;border-radius:8px}.fill-editor-item{padding:8px}.fill-editor-head{font-size:8px}.paper-section-heading{font-size:8px;padding:6px 7px}.paper-fill-statement{margin-left:14px;font-size:8.5px}.question-options{grid-template-columns:1fr;gap:5px}.match-editor-grid{grid-template-columns:1fr;gap:8px}.match-row{grid-template-columns:20px minmax(0,1fr) 25px;gap:5px}.passage-question-row{grid-template-columns:minmax(0,1fr) 55px 25px;gap:4px}.planner-table th{font-size:6.5px;padding:6px}.planner-recommendation-card{flex-basis:175px;padding:6px}.planner-recommendation-title{font-size:8px}.planner-recommendation-meta{font-size:6.5px}.planner-recommendation-match{font-size:6px;padding:2px 5px}.planner-recommendation-actions{gap:3px}.planner-recommendation-actions .planner-btn{padding:5px 6px;font-size:7px}.planner-chapter-entry{gap:4px}.planner-chapter-entry .planner-btn{padding:6px 7px;font-size:7px}.planner-chapter-chip{font-size:6.5px;padding:3px 5px}.planner-table td{padding:6px}.paper-preview-wrap{padding:7px}.paper-a4{width:650px;min-height:919px;padding:30px}.paper-a4 h1{font-size:18px}.paper-a4 .paper-meta{font-size:8px}.paper-question{font-size:9px}.paper-options{font-size:8px}.planner-modal{padding:6px}.planner-modal-card{border-radius:11px}.planner-modal-head{padding:9px 11px}.planner-modal-body{padding:9px}.teacher-audit-group{padding:9px;border-radius:12px}.teacher-name{font-size:12px}.teacher-sub{font-size:7px}}
...
function addDaysToPlannerDate(dateValue: string, days: number) {
  if (!dateValue) return "";
...
function plannerWeekday(dateValue: string) {
  if (!dateValue) return "";
  const date = new Date(`${dateValue}T00:00:00`);
  if (Number.isNaN(date.getTime())) return "";
...
export function LessonComposer({ blocks, onChange, startDate = "", endDate = "", defaultChapter = "" }: { blocks: LessonBlock[]; onChange:(blocks:LessonBlock[])=>void; startDate?: string; endDate?: string; defaultChapter?: string }) {
  const fileRef = useRef<HTMLInputElement|null>(null);
  const [pendingImage, setPendingImage] = useState<string|null>(null);
  const firstChapter = blocks.find(block => block.type === "chapter" && Boolean(block.value?.trim()))?.value?.trim() ?? "";

  const add = (type: LessonBlock["type"]) => {
    if (type === "date") {
      const dateIndex = blocks.filter(block => block.type === "date").length;
      const nextDate = addDaysToPlannerDate(startDate, dateIndex);
      if (startDate && endDate && nextDate && nextDate > endDate) return;
      onChange([...blocks, { id: uid("block"), type: "date", value: nextDate }]);
      return;
    }
    if (type === "day") {
      const dayIndex = blocks.filter(block => block.type === "day").length;
      const nextDate = addDaysToPlannerDate(startDate, dayIndex);
      if (startDate && endDate && nextDate && nextDate > endDate) return;
      onChange([...blocks, { id: uid("block"), type: "day", value: plannerWeekday(nextDate) || "Monday" }]);
      return;
    }
    if (type === "chapter") {
      onChange([...blocks, { id: uid("block"), type: "chapter", value: firstChapter || defaultChapter }]);
      return;
    }
    onChange([...blocks, { id: uid("block"), type, value: "" }]);
  };

  const update = (id:string, value:string) => {
    const target = blocks.find(block => block.id === id);
    if (target?.type === "chapter") {
      const firstChapterBlock = blocks.find(block => block.type === "chapter");
      const currentFirstChapter = blocks.find(block => block.type === "chapter" && Boolean(block.value?.trim()))?.value?.trim() ?? "";
      const nextChapter = value.trim();
      const isFirstChapter = target.id === firstChapterBlock?.id;
      const otherChaptersMatchMaster = blocks
        .filter(block => block.type === "chapter" && block.id !== firstChapterBlock?.id)
        .every(block => !block.value?.trim() || block.value.trim() === currentFirstChapter);
      const shouldPropagate = isFirstChapter && (!currentFirstChapter || otherChaptersMatchMaster);

      // Keep the exact value the teacher typed in the input.
      // In particular, do not trim the controlled value while typing: trimming
      // here would make a trailing space appear impossible to enter.
      if (shouldPropagate) {
        onChange(blocks.map(block => block.type === "chapter" ? { ...block, value } : block));
        return;
      }
    }
...
export function PaperPreview({ record, onClose, editable=false, onSaveEdit }: { record:PlannerRecord; onClose:()=>void; editable?:boolean; onSaveEdit?:(payload:QuestionPaperPayload)=>void }) {
  ...
  const [chapter,setChapter]=useState(p.chapter ?? "");
  const [chapters,setChapters]=useState<string[]>(p.chapters ?? []);
  const total=useMemo(()=>questions.reduce((s,q)=>s+Number(q.marks||0),0),[questions]);
  const currentPayload: QuestionPaperPayload = { ...p, schoolName, chapter: chapter || undefined, chapters: chapters.length ? chapters : undefined, questions, totalMarks: total || p.totalMarks };
  const sections=getPaperSections(questions);
  let globalNumber=1;
  return <div className="planner-modal"><div className="planner-modal-card"><div className="planner-modal-head"><strong>Paper Preview · A4</strong><div className="planner-actions"><button className="planner-btn" onClick={onClose}>Close</button><button className="planner-btn" onClick={()=>printPlannerRecord({...record,payload:currentPayload})}>Download / Save PDF</button>{editable&&onSaveEdit&&<button className="planner-btn primary" onClick={()=>onSaveEdit(currentPayload)}>Save edits</button>}</div></div><div className="planner-modal-body"><div className="paper-preview-wrap"><article className="paper-a4"><div className="print-kicker" style={{textAlign:"center"}}>{record.plannerType === "unit_test" ? "UNIT TEST" : "EXAMINATION PAPER"}</div><h1>{record.title}</h1><div style={{textAlign:"center",fontSize:11,fontWeight:800}}>{record.subjectName}</div><div className="paper-meta"><span><strong>School:</strong> {p.schoolName}</span><span><strong>Total Marks:</strong> {total || p.totalMarks}</span><span><strong>Date:</strong> {fmtDate(record.startDate)}</span><span><strong>Day:</strong> {record.startDate ? new Date(record.startDate).toLocaleDateString("en-IN",{weekday:"long"}) : ""}</span><span><strong>Time Allowed:</strong> {p.timeAllowed}</span><span><strong>Class:</strong> {record.className} · Section {record.sectionName}</span></div><div className="print-instructions" style={{fontSize:9,marginBottom:14,padding:8,borderLeft:"3px solid #F97316",background:"#F8FAFC"}}><strong>General Instructions:</strong> Read all questions carefully. Marks allotted to each question are shown against it. Answer all questions as instructed in each section.</div>{sections.map(section=><section className="paper-section" key={section.key}><div className="paper-section-heading"><span>{section.title}</span><span>{sectionMarks(section)} Marks</span></div><div className="paper-section-description" style={{fontSize:9,color:"#64748B",fontStyle:"italic",margin:"6px 0 8px"}}>{section.description}</div>{section.questions.map(q=><PaperQuestionPreview key={q.id} q={q} index={globalNumber++}/>)}</section>)}</article></div>{editable&&<><div className="planner-grid" style={{marginTop:12}}><div className="planner-field"><label>School name</label><input value={schoolName} onChange={e=>setSchoolName(e.target.value)} placeholder="Enter your school name"/></div><div className="planner-field"><label>{record.plannerType === "unit_test" || record.plannerType === "exam_paper" ? "Chapters" : "Chapter name"}</label><input value={chapters.length ? chapters.join(", ") : chapter} onChange={e=>{setChapter(e.target.value);setChapters([])}} placeholder="Edit chapter details"/></div></div><div style={{marginTop:12}}><QuestionEditor questions={questions} onChange={setQuestions}/></div></>}</div></div></div>;
}
...
export type PlannerTimeFilter = "ALL" | "7D" | "14D" | "30D" | "60D" | "CUSTOM";

export function PlannerAuditFilters({
  records, teacherName, className, sectionName, timeFilter, customStart, customEnd,
  onTeacherNameChange, onClassChange, onSectionChange, onTimeFilterChange, onCustomStartChange, onCustomEndChange,
}: {
  records: PlannerRecord[]; teacherName: string; className: string; sectionName: string; timeFilter: PlannerTimeFilter;
  customStart: string; customEnd: string; onTeacherNameChange: (value:string)=>void; onClassChange:(value:string)=>void;
  onSectionChange:(value:string)=>void; onTimeFilterChange:(value:PlannerTimeFilter)=>void; onCustomStartChange:(value:string)=>void; onCustomEndChange:(value:string)=>void;
}) {
  const classes = useMemo(() => Array.from(new Set(records.map(r=>r.className).filter(Boolean))).sort((a,b)=>a.localeCompare(b)), [records]);
  const sections = useMemo(() => Array.from(new Set(records.filter(r=>!className || r.className===className).map(r=>r.sectionName).filter(Boolean))).sort((a,b)=>a.localeCompare(b)), [records,className]);
  return <div className="planner-filter-bar" role="search" aria-label="Planner filters">
    <div className="planner-filter-field"><label>Teacher name</label><input value={teacherName} onChange={e=>onTeacherNameChange(e.target.value)} placeholder="Search teacher name"/></div>
    <div className="planner-filter-field"><label>Class</label><select value={className} onChange={e=>onClassChange(e.target.value)}><option value="">All classes</option>{classes.map(v=><option key={v} value={v}>{v}</option>)}</select></div>
    <div className="planner-filter-field"><label>Section</label><select value={sectionName} onChange={e=>onSectionChange(e.target.value)}><option value="">All sections</option>{sections.map(v=><option key={v} value={v}>{v}</option>)}</select></div>
    <div className="planner-filter-field"><label>Time</label>{timeFilter==="CUSTOM"?<div className="planner-filter-custom"><input type="date" value={customStart} onChange={e=>onCustomStartChange(e.target.value)} aria-label="Custom start date"/><input type="date" value={customEnd} onChange={e=>onCustomEndChange(e.target.value)} aria-label="Custom end date"/></div>:<select value={timeFilter} onChange={e=>onTimeFilterChange(e.target.value as PlannerTimeFilter)}><option value="ALL">All time</option><option value="7D">Last 1 week</option><option value="14D">Last 2 weeks</option><option value="30D">Last 30 days</option><option value="60D">Last 60 days</option><option value="CUSTOM">Custom dates</option></select>}</div>
  </div>;
}

export function PlannerRecommendations({ recommendations, loading=false, error="", onPreview, onUse }: { recommendations: PlannerRecommendation[]; loading?: boolean; error?: string; onPreview:(record:PlannerRecommendation)=>void; onUse:(record:PlannerRecommendation)=>void }) {
  if (loading) return <div className="planner-recommendations"><div className="planner-recommendations-head"><div><div className="planner-recommendations-title">Recommended planners</div><div className="planner-recommendations-copy">Checking matching class and chapter records…</div></div></div><div className="planner-recommendation-loading">Searching submitted planners.</div></div>;
  if (error) return <div className="planner-recommendations"><div className="planner-recommendations-title">Recommended planners</div><div className="planner-recommendation-error">{error}</div></div>;
  if (!recommendations.length) return null;
  return <div className="planner-recommendations"><div className="planner-recommendations-head"><div><div className="planner-recommendations-title">Recommended planners · {recommendations.length}</div><div className="planner-recommendations-copy">Scroll horizontally to compare submitted planners. School identity is hidden.</div></div></div><div className="planner-recommendation-scroll">{recommendations.map(r=><article className="planner-recommendation-card" key={r.id}><div className="planner-recommendation-title">{r.title || "Untitled planner"}</div><div className="planner-recommendation-meta">{r.teacherName || "Teacher"} · {r.className} · Section {r.sectionName}<br/>{r.subjectName || "Subject"}</div><span className="planner-recommendation-match">{r.matchPercent != null ? `${r.matchPercent}% chapter match` : "Class + chapter match"}</span><div className="planner-recommendation-actions"><button className="planner-btn" onClick={()=>onPreview(r)}>Preview</button><button className="planner-btn primary" onClick={()=>onUse(r)}>Use &amp; Edit</button></div></article>)}</div></div>;
}

export function preparePlannerRecommendation(record: PlannerRecommendation): PlannerRecord {
  const payload = JSON.parse(JSON.stringify(record.payload ?? {})) as any;
  if (record.plannerType !== "lesson") payload.schoolName = "";
  return { ...record, id: `recommendation:${record.id}`, schoolUuid: "", teacherUuid: "", payload };
}
