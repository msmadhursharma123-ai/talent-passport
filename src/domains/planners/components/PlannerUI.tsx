...
export function LessonComposer({ blocks, onChange, startDate = "", endDate = "" }: { blocks: LessonBlock[]; onChange:(blocks:LessonBlock[])=>void; startDate?: string; endDate?: string }) {
  ...
  const add = (type: LessonBlock["type"]) => {
    ...
    if (type === "chapter") {
      onChange([...blocks, { id: uid("block"), type: "chapter", value: firstChapter }]);
      return;
    }
